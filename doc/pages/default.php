 ...
 <div id="old_search">
    ...
    <div class="b_cont" id="disp_default">
            ...
            <?php
                ...
                $my_query = "SELECT DISTINCT * FROM dwd_all_file_info WHERE dwd_afi_file_type IN ('pdf','docx','xlsx', 'ppt', 'pptx', 'txt')  ORDER BY dwd_afi_file_num_of_downloads DESC LIMIT 18";
                ...
                while($result_line = mysqli_fetch_array($my_result)){
                  ...
                  echo'<div class="col-xs-2 col-md-2">
                            ...
                            <span class="glyphicon glyphicon-book" aria-hidden="true" style="font-size:5vw;cursor:pointer; color:#676565;"></span><br>                       <a style="font-weight:normal; font-size:1vw;cursor:pointer;" class="wordwrap"> '.$result_line['dwd_afi_file_name'].'</a>
                    </div>
                  '; 
                  if(($i+1) % 6 ==0)
                    echo '</div>';$i++;
