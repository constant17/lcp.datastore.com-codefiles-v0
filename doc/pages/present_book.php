...
<div class="b_cont">
	<!--Present the book to th euser-->
        ...
        <div class="col-xs-8"><div class="wordwrap"-->
				...
				echo '<h2 id="office-presentation-odp-">Nom du document</h2>
				<iframe src = "ViewerJS/#../files/education/myfile.pdf" width="800vw" height="550vw" allowfullscreen webkitallowfullscreen></iframe>';
