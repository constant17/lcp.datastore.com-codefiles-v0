...
<nav>
  <ul id="yep_menu">
        	...
        	<li id="#" ><a href="../vid/"> <b>Videos</b></a></li>
            ...
            <li id="forum"><a href="../index.php?p=frm">Forum</a></li>
            ...
            <li id="messenger" onClick=""><a href="#">Messagerie</a></li>
      ...
      <ul id="nope_menu">
        ...
        <option value="#" id="vid1" >Videos</option> 
...
<div id="login_box" class="log_box"><span clas class="close">&times;</span>
      ...
      <center><h3>Connexion</h3></center>
      	<table cols="2" class="reg_info" cellpadding="0" cellspacing="10" width="60%" height="60%" style="margin:2rem;">
        <tr><td><div id="disp_error" class="alert alert-danger" style="display:none;padding:0.5rem;text-align:center;width:96%;"></div></td></tr>
        <tr><td>
...
<div id="reg_box" class="reg_box">
      ...
      <table cols="2" class="reg_info" cellpadding="0" cellspacing="10" width="60%" height="60%" style="margin:auto;"><tr><td>
		...
		<div id="disp_error_reg" class="alert alert-danger" style="display:none;padding:0.5rem;text-align:center;width:96%;"></div>
       		<div class='input-group' style="margin:1rem;">
