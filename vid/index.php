...
<script type="text/javascript" src="design/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="design/projekktor-1.3.09.min.js"></script>
<style>
...
<script type="text/javascript">
         $(document).ready(function() {
               pprojekktor('#player_a', {
				volume: 0.8,
				playerFlashMP4: 'StrobeMediaPlayback/StrobeMediaPlayback.swf',
				playerFlashMP3: 'StrobeMediaPlayback/StrobeMediaPlayback.swf'
    });
});
...
<!--div class="page_content" id="p_content">
       ...
       <a href="files/pdf/Pagoui.pdf"> <p>It appears your web browser doesn't support iframes.</p></a>
