...
<div class="b_cont">
	<!--Present the book to th euser-->
        ...
        <div class="col-xs-8"><div class="wordwrap"-->
            
                <?php 
				$f_path = substr(realpath(dirname(__FILE__)), 0, strlen(realpath(dirname(__FILE__)))-5);
				echo '<iframe src="'.$f_path.'files/education/myfile.pdf" type="application/pdf" style="width:70%; height:40em">
                 <p>Alternative text - include a link <a href="'.$f_path.'/files/education/myfile.pdf">to the PDF!</a></p>				
                </iframe>';
					/*echo  "<object data='".$f_path."'/files/education/myfile.pdf' type='application/pdf' style='width:70%; height:40em;'>
					<embed src='".$f_path."'/files/education/myfile.pdf' type='application/pdf' style='width:70%; height:40em'></embed>
					</object>";*/
				 ?>
